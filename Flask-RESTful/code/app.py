...
class Item(Resource):
    ...
    @jwt_required()     # authentication enabled using JWT and this decorator.
    def get(self, name):
...
# A. It is 200, not 404.
    ...
    def post(self, name):
        ...
        # below code is deprecated when we used parser above. And grabbed data after request parsing as 'data = parser.parse_args()'. 
